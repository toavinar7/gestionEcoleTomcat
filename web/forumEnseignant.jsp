                                        ...
                                        <div class="active tab-pane" id="activity">
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <span class="username">
                                                        <a href="#"><%=enseignantConnect.getNom() + " " + enseignantConnect.getPrenom()%></a>
                                            ...
                                            <form method="post" action="ServletInsererForum" class="form-horizontal">
                                                <div class="form-group margin-bottom-none">
                                                    <input type="hidden" name="personne"value="enseignant">
                                                    <input type="hidden" name="idpersonne"value="<%=enseignantConnect.getId()%>">
                                                    <div class="col-sm-11">
                                        ...
                                        <div class="post clearfix">
                                            ...
                                            <form method="get" action="ServletInsererForum" class="form-horizontal">
                                                <div class="form-group margin-bottom-none">
                                                    ...
                                                    <input type="hidden" name="code"value="enseignant">
                                                    <input type="hidden" name="idpersonne"value="<%=enseignantConnect.getId()%>">
