...
//idClasse
    int idClasse=(Integer)request.getAttribute("idClasse");
    List<NoteEleve> noteEleve = (ArrayList<NoteEleve>) request.getAttribute("noteEleve");
    List<Semestre> lsitSemestre = (ArrayList<Semestre>) request.getAttribute("Semestre");
%>
<!DOCTYPE html>
<html>
    <title>index</title>
            ...
            <jsp:include page="menuLeftParent.jsp"></jsp:include>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="col-lg-2">
                            <form method="get" action="GetNoteParent1">
                                <div class="form-group">
                                    <div class="form-group has-feedback">
                                                    ...
                                                    <input type="hidden" name="idEtudiant" value="<%=noteEleve.get(0).getEtudiant().getId() %>">
