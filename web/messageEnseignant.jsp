                                    ...
                                    <div class="col-md-9">
                                        <div class="box box-warning direct-chat direct-chat-warning" >
                                            <div class="box-header with-border">
                                                ...
                                                <a href="ChatEnseignantServlet?idCt=<%=idCtct%>&type=<%=typeCtct%>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
                                            ...
                                            <div class="direct-chat-contacts" style="height: 410px">
                                                ...
                                                <ul class="contacts-list">
                                                    ...
                                                    <li>
                                                        <a href="ChatEnseignantServlet?idCt=<%=ladm.get(i).getId() %>&type=admin">
                                                    ...
                                                    <li>
                                                        <a href="ChatEnseignantServlet?idCt=<%=letud.get(i).getId() %>&type=etudiant">
                                                            <img class="contacts-list-img" src="bootstrap/dist/img/userifr.jpg" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="ChatEnseignantServlet?idCt=<%=lens.get(i).getId() %>&type=enseignant">
                                                            <img class="contacts-list-img" src="bootstrap/dist/img/userifr.jpg" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="ChatEnseignantServlet?idCt=<%=lpar.get(i).getId() %>&type=parent">
                                                            <img class="contacts-list-img" src="bootstrap/dist/img/userifr.jpg" alt="User Image">
                                        ...
                                        <div class="box-footer">
                                            <form action="ChatEnseignantServlet" method="post">
                                                <div class="input-group">
                                                    <input type="hidden" name="idCtct" value="<%=idCtct %>">
                                                    <input type="hidden" name="typeCtct" value="<%=typeCtct %>">
                                                    <input type="hidden" name="idPers" value="<%=enseignantConnect.getId() %>">
                                                    <input type="hidden" name="typePers" value="enseignant">
