                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <span class="username">
                                                        <a href="#"><%=etudiant.getNom() + " " + etudiant.getPrenom()%></a>
                                            ...
                                            <form method="post" action="ServletInsererForum" class="form-horizontal">
                                                <div class="form-group margin-bottom-none">
                                                    <input type="hidden" name="personne"value="etudiant">
                                                    <input type="hidden" name="idpersonne"value="<%=etudiant.getId()%>">
                                                    <div class="col-sm-11">
                                        ...
                                        <div class="post clearfix">
                                            ...
                                            <h6 style="text-decoration: solid;">Commentaire</h6>
                                            ...
                                            <form method="get" action="ServletInsererForum" class="form-horizontal">
                                                <div class="form-group margin-bottom-none">
                                                    ...
                                                    <input type="hidden" name="code"value="eleve">
                                                    <input type="hidden" name="idpersonne"value="<%=etudiant.getId()%>">
